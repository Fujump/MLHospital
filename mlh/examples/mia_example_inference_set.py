    ...
    if attack_type == "label-only":
        ...
        if attack_type == "augmentation":
            attack_dataset_rotation = AugemtaionAttackDataset( args, "rotation" , target_model, shadow_model,
                                            target_inference_loader.dataset, target_test_loader.dataset, shadow_inference_loader.dataset, shadow_test_loader.dataset,args.device)
            ...
            attack_dataset = AttackDataset(args, attack_type, target_model, shadow_model,
                                        target_inference_loader, target_test_loader, shadow_inference_loader, shadow_test_loader)
